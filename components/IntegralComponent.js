            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 bg-gray-50 p-4 rounded-lg border">
                        <div>
                            <label class="text-xs font-bold text-gray-600 block mb-1">$\\delta_1$ - Integrallashgan baho $I_i$ uchun chegaraviy mezon:</label>
                            ...
                            <span class="text-[11px] text-gray-400">Joriy $I_i$: {{ (integralScore/100).toFixed(4) }}</span>
                        </div>
                        <div>
                            <label class="text-xs font-bold text-gray-600 block mb-1">$\\delta_2$ - Minimal ko'rsatkich $m_i$ uchun chegaraviy mezon:</label>
                            ...
                            <span class="text-[11px] text-gray-400">Joriy $m_i$ (min): {{ Math.min(m1FinalScore/100, m2FinalScore/100, m3FinalScore/100).toFixed(4) }}</span>
                        </div>
                    </div>
                </div>
